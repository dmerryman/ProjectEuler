...
{
    /// <summary>
    /// Summary description for SelfPowersTests
    /// </summary>
    [TestClass]
    public class SelfPowersTests
    {
        public SelfPowersTests()
        {
            //
        ...
        [TestMethod]
        public void TestFindSelfPowers()
        {
            Assert.AreEqual(405071317, ProjectEuler.Problems41_50.SelfPowers.FindSelfPowers(limit: 10));
        }
